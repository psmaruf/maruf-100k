      ...
      if (isKicked) {
        if (isSpecialAdmin) {
          ...
          const customKickMessages = [
            ...
            `👋 "${userName}" বাই-বাই! মারুফ বস তোর নাম শুনেই রেগে গিয়েছিল!\n\nGroup: ${groupName}\nTime: ${bdTime}`,
        ...
        const customLeaveMessages = [
          `😂 "${userName}" ভাই, মারুফ বসের মার খাওয়ার ভয়ে পালালা নাকি?\n\nGroup: ${groupName}\nTime: ${bdTime}`,
          `🏃‍♂️ ওই দেখ! "${userName}" এর স্পিড দেখ! বাঁধন বস আসছেন!\n\nGroup: ${groupName}\nTime: ${bdTime}`,
          `😆 "${userName}" রে বাবা! এত ভয়? বাঁধন বসের ছায়া দেখেই পালালি!\n\nGroup: ${groupName}\nTime: ${bdTime}`,
          `🤣 "${userName}" তুই পালাস কেন? বাঁধন বস তো শুধু তোর প্রোফাইল পিক দেখছিল!\n\nGroup: ${groupName}\nTime: ${bdTime}`,
          ...
          `🏎️ "${userName}" এর স্পিড লিমিট ছাড়িয়ে গেছে! মারুফ বস পিছনে!\n\nGroup: ${groupName}\nTime: ${bdTime}`,
          `🪂 "${userName}" প্যারাসুট নিয়ে লাফ দিল! মারুফ বসের গ্রুপ থেকে!\n\nGroup: ${groupName}\nTime: ${bdTime}`,
          `🌪️ "${userName}" কে ঘূর্ণিঝড়ে উড়িয়ে নিল! মারুফ  বসের রাগে!\n\nGroup: ${groupName}\nTime: ${bdTime}`
        ];
